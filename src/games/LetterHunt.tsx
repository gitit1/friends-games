...
// a11y (2026-08-02): the blocks carry the child touch bar (72px, --tap-min), and
// at that size the old spots genuinely COLLIDED — measured overlaps of up to
// 22x24px, so one block stole its neighbour's taps. (They already overlapped at
// the previous 56px; the "never overlap" claim here was wrong.) The grid below is
// spread to a 3-2-3 arrangement with >=26% horizontal and >=17% vertical
// separation, which clears a 72px block on a 360px-wide scene.
const SPOTS: { top: number; left: number }[] = [
  { top: 26, left: 20 }, { top: 26, left: 50 }, { top: 26, left: 80 },
  { top: 50, left: 30 }, { top: 50, left: 70 },
  { top: 76, left: 20 }, { top: 76, left: 50 }, { top: 76, left: 80 },
]
